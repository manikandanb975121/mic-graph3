...
GET_URL = 'https://graph.microsoft.com/beta/security/tiindicators/'
...
READ_DIRECTORY_NAME ='readTiindicators'
COMMON_DIRECTORY_NAME = 'common_id'
MISP_DIRECTORY_NAME = 'misp_events'
COMMON_EVENTS_DIRECTORY_NAME = 'common events'
MISP_GRAPH = 'misp_graph'
